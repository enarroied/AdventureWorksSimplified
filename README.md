...
- [Simplified Star from AdventureWorksDW](#simplified-star-from-adventureworksdw)
  - [Other formats](#other-formats)
  - [Installation](#installation)
  - [Structure](#structure)
  - [Example usage](#example-usage)
    - [What products have more sales?](#what-products-have-more-sales)
    - [What are our sales by shipping Month?](#what-are-our-sales-by-shipping-month)
...
AdventureWorksDW (DW for "Data Warehouse") comes in various flavors of Microsoft-related technologies: `Transact SQL`, `SQL Server`, and even as Power Bi projects. You can find `PostgreSQL` dumps out there on GitHub, but I was unable to make them work.
...
![screenshot of the ERD](img/star.png)
